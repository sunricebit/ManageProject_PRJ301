...
public class BoardController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ProjectProgressDAO d= new ProjectProgressDAO();
            ArrayList<ProjectProgress> listAll = d.getAll();
            ...
            ArrayList<ProjectProgress> list = d.getListByPage(listAll, start, end);
             ...
             request.getRequestDispatcher("ProjectProgress.jsp").forward(request, response);
