                        ...
                        <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                            ...
                            <form action="SignUp" method="post">
                                <div class="form-floating mb-2">
                                    <input type="text" class="form-control" id="floatingText" placeholder="First Name" name="firstName">
                                    <label for="floatingText">First Name</label>
                                </div>
                                <div class="form-floating mb-2">
                                    <input type="text" class="form-control" id="floatingText" placeholder="lastName" name="lastName">
