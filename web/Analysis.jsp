<%-- 
    Document   : Analysis
    Created on : Jul 12, 2022, 11:12:46 PM
    Author     : ADMIN
--%>
        ...
        <div class="container-xxl position-relative bg-white d-flex p-0">
            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    <a href="Home" class="navbar-brand mx-4 mb-3">
                        <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>PM</h3>
                    </a>
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="Navigation?goal=Analysis.jsp" class="nav-item nav-link active"><i class="fa fa-chart-bar me-2"></i>Analysis</a>
                    </div>
                </nav>
            </div>
            <!-- Sidebar End -->
            ...
            <div class="content">
                ...
                <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                    ...
                    <a href="Home" class="sidebar-toggler flex-shrink-0">
                    ...
                    <div class="navbar-nav align-items-center ms-auto">
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                                ...
                                <hr class="dropdown-divider">
                                <a href="Navigation?goal=Notification.jsp" class="dropdown-item text-center">See all notifications</a> <!-- Add notification and show all -->
                            </div>
                        </div>
                        <div class="nav-item dropdown">
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="row g-4">
                        ...
                        <div class="col-sm-12 col-xl-6">
                            <div class="bg-light rounded h-100 p-4">
                                <h6 class="mb-4">Work productivity</h6>
