<%-- 
    Document   : Calendar
    Created on : Jul 7, 2022, 8:41:44 PM
    Author     : ADMIN
--%>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="Navigation?goal=Calendar.jsp" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Calendar</a>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <hr class="dropdown-divider">
                            <a href="Notification" class="dropdown-item text-center">See all notifications</a> <!-- Add notification and show all -->
                        </div>
                    </div>
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="Home">Project Manager</a>, All Right Reserved. 
                        </div>
                    </div>
                </div>
            </div>
